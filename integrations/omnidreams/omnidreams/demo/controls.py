...
"""OmniDreams-owned keyboard segmenting and camera pose integration."""
...
class KeyboardResampler:
    """Resample sparse keydown/keyup edges into an OmniDreams driving timeline."""
    ...
    def __init__(
        ...
        *,
        fps: float,
        start_v: float = 0.0,
        supported_keys: frozenset[str] = WSAD_SUPPORTED_KEYS,
    ) -> None:
        if fps <= 0:
